...
class ViewPatientMedicalTests extends StatefulWidget {
  ViewPatientMedicalTests({required this.id});

  int id;

  @override
  State<ViewPatientMedicalTests> createState() =>
      _ViewPatientMedicalTestsState();
}

class _ViewPatientMedicalTestsState extends State<ViewPatientMedicalTests> {
  @override
...
//get request
  ...
  void fetchPrescriptions() async {
    final fetchedTests = await service.getPatientMedicalTestsLab(widget.id);
    isLoading = false;
